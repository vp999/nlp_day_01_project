...
class Testing(unittest.TestCase):
    ...
    def test_return_1(self):
        self.assertListEqual(self.student_return[1], self.original_return[1], "The return values do not match expected values")
    ...
    def test_return_3(self):
        assert_array_equal(self.student_return[3], self.original_return[3], "The return values do not match expected values")

    def test_return_4(self):
        assert_array_equal(self.student_return[4], self.original_return[4], "The return values do not match expected values")
